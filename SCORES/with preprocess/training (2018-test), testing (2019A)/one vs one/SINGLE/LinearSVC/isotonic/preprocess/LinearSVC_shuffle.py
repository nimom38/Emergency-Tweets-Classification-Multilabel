...
def main():
  ...
  classifier = Pipeline([
     ...
     ('clf', CalibratedClassifierCV(base_estimator = LinearSVC(C=10.0, class_weight=None, dual=True, fit_intercept=True,
      intercept_scaling=1, loss='squared_hinge', max_iter=1000,
      multi_class='ovr', penalty='l2', random_state=0, tol=0.0001,
      verbose=0), method = 'isotonic'))])

  classifier.fit(X_train, Y_train)

  joblib.dump(classifier, "LinearSVC_shuffle.pkl") 
