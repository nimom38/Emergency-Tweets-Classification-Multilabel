...
def main():
  ...
  from sklearn.neural_network import MLPClassifier
  classifier = Pipeline([
     ('count_vectorizer', CountVectorizer(ngram_range=(1, 3), max_df=0.95, min_df=1, max_features=16000)),
     ('clf', MLPClassifier(hidden_layer_sizes=(200,), random_state=1, max_iter=1000, warm_start=True))])

  classifier.fit(X_train, Y_train)

  joblib.dump(classifier, "model_200_shuffle.pkl") 
