...
def main():
  ...
  classifier = Pipeline([
     ...
     ('clf', MLPClassifier(hidden_layer_sizes=(100, 100, 100, 100), random_state=1, max_iter=1000, warm_start=True))])

  classifier.fit(X_train, Y_train)

  joblib.dump(classifier, "model_100_100_100_100_shuffle.pkl") 
