...
def main():
  ...
  classifier = Pipeline([
     ...
     ('clf', MLPClassifier(hidden_layer_sizes=(200, 200, 200, 200), random_state=1, max_iter=1000, warm_start=True))])

  classifier.fit(X_train, Y_train)

  joblib.dump(classifier, "model_200_200_200_200_shuffle.pkl") 
