...
def main():
  ...
  classifier = Pipeline([
     ...
     ('clf', CalibratedClassifierCV(base_estimator = RandomForestClassifier(max_depth=2, random_state=0), method = 'isotonic'))])

  classifier.fit(X_train, Y_train)

  joblib.dump(classifier, "Random_forest_shuffle.pkl") 
